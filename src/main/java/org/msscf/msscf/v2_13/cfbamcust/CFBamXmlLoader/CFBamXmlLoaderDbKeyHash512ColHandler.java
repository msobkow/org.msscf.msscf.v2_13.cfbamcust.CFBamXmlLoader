...
/*
 *	CFBamXmlLoaderDbKeyHash512ColParse XML SAX Element Handler implementation
 *	for DbKeyHash512Col.
 */
public class CFBamXmlLoaderDbKeyHash512ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash512ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash512ColEditObj editBuff = (ICFBamDbKeyHash512ColEditObj)schemaObj.getDbKeyHash512ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash512ColEditObj editDbKeyHash512Col = editBuff;
			ICFBamDbKeyHash512ColObj origDbKeyHash512Col = (ICFBamDbKeyHash512ColObj)editDbKeyHash512Col.create();

...
/*
 *	CFBamXmlLoaderDbKeyHash256ColParse XML SAX Element Handler implementation
 *	for DbKeyHash256Col.
 */
public class CFBamXmlLoaderDbKeyHash256ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash256ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash256ColEditObj editBuff = (ICFBamDbKeyHash256ColEditObj)schemaObj.getDbKeyHash256ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash256ColEditObj editDbKeyHash256Col = editBuff;
			ICFBamDbKeyHash256ColObj origDbKeyHash256Col = (ICFBamDbKeyHash256ColObj)editDbKeyHash256Col.create();

...
/*
 *	CFBamXmlLoaderUuid6TypeParse XML SAX Element Handler implementation
 *	for Uuid6Type.
 */
public class CFBamXmlLoaderUuid6TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuid6TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuid6TypeEditObj editBuff = (ICFBamUuid6TypeEditObj)schemaObj.getUuid6TypeTableObj().newInstance().beginEdit();
			...
			ICFBamUuid6TypeEditObj editUuid6Type = editBuff;
			ICFBamUuid6TypeObj origUuid6Type = (ICFBamUuid6TypeObj)editUuid6Type.create();
			editUuid6Type = null;

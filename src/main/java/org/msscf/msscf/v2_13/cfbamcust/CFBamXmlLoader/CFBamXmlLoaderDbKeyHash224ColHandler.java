...
/*
 *	CFBamXmlLoaderDbKeyHash224ColParse XML SAX Element Handler implementation
 *	for DbKeyHash224Col.
 */
public class CFBamXmlLoaderDbKeyHash224ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash224ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash224ColEditObj editBuff = (ICFBamDbKeyHash224ColEditObj)schemaObj.getDbKeyHash224ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash224ColEditObj editDbKeyHash224Col = editBuff;
			ICFBamDbKeyHash224ColObj origDbKeyHash224Col = (ICFBamDbKeyHash224ColObj)editDbKeyHash224Col.create();

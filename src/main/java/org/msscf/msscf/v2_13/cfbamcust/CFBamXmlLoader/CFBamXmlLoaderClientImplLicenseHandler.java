 ...
 */
public class CFBamXmlLoaderClientImplLicenseHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderClientImplLicenseHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "ClientImplLicense" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalClientImplLicenseText( text );

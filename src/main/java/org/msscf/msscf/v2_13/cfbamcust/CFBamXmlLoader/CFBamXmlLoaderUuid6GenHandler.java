...
/*
 *	CFBamXmlLoaderUuid6GenParse XML SAX Element Handler implementation
 *	for Uuid6Gen.
 */
public class CFBamXmlLoaderUuid6GenHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuid6GenHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuid6GenEditObj editBuff = (ICFBamUuid6GenEditObj)schemaObj.getUuid6GenTableObj().newInstance().beginEdit();

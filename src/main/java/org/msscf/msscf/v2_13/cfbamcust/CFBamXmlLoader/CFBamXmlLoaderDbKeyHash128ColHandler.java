...
/*
 *	CFBamXmlLoaderDbKeyHash128ColParse XML SAX Element Handler implementation
 *	for DbKeyHash128Col.
 */
public class CFBamXmlLoaderDbKeyHash128ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash128ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash128ColEditObj editBuff = (ICFBamDbKeyHash128ColEditObj)schemaObj.getDbKeyHash128ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash128ColEditObj editDbKeyHash128Col = editBuff;
			ICFBamDbKeyHash128ColObj origDbKeyHash128Col = (ICFBamDbKeyHash128ColObj)editDbKeyHash128Col.create();

 ...
 */
public class CFBamXmlLoaderServerXFaceLicenseHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderServerXFaceLicenseHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "ServerXFaceLicense" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalServerXFaceLicenseText( text );

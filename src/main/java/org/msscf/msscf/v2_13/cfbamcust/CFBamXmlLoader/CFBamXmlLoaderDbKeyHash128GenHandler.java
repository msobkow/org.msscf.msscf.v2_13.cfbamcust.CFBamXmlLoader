...
/*
 *	CFBamXmlLoaderDbKeyHash128GenParse XML SAX Element Handler implementation
 *	for DbKeyHash128Gen.
 */
public class CFBamXmlLoaderDbKeyHash128GenHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash128GenHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash128GenEditObj editBuff = (ICFBamDbKeyHash128GenEditObj)schemaObj.getDbKeyHash128GenTableObj().newInstance().beginEdit();

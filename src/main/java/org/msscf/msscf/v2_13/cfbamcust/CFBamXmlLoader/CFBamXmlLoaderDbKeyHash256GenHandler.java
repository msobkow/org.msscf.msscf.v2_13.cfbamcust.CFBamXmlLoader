...
/*
 *	CFBamXmlLoaderDbKeyHash256GenParse XML SAX Element Handler implementation
 *	for DbKeyHash256Gen.
 */
public class CFBamXmlLoaderDbKeyHash256GenHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash256GenHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash256GenEditObj editBuff = (ICFBamDbKeyHash256GenEditObj)schemaObj.getDbKeyHash256GenTableObj().newInstance().beginEdit();
			...
			CFLibDbKeyHash256 natInitValue;
			if( ( attrInitValue == null ) || ( attrInitValue.length() <= 0 ) ) {
				natInitValue = CFLibDbKeyHash256.nullGet();
			}
			else {
				natInitValue = CFLibDbKeyHash256.fromHex( attrInitValue );
			}
			...
			ICFBamDbKeyHash256GenEditObj editDbKeyHash256Gen = editBuff;
			ICFBamDbKeyHash256GenObj origDbKeyHash256Gen = (ICFBamDbKeyHash256GenObj)editDbKeyHash256Gen.create();

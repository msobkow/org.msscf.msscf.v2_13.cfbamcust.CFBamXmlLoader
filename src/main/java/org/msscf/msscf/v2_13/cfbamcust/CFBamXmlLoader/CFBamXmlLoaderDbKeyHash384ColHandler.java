...
/*
 *	CFBamXmlLoaderDbKeyHash384ColParse XML SAX Element Handler implementation
 *	for DbKeyHash384Col.
 */
public class CFBamXmlLoaderDbKeyHash384ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash384ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash384ColEditObj editBuff = (ICFBamDbKeyHash384ColEditObj)schemaObj.getDbKeyHash384ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash384ColEditObj editDbKeyHash384Col = editBuff;
			ICFBamDbKeyHash384ColObj origDbKeyHash384Col = (ICFBamDbKeyHash384ColObj)editDbKeyHash384Col.create();

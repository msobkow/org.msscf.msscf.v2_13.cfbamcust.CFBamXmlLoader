...
/*
 *	CFBamXmlLoaderUuid6ColParse XML SAX Element Handler implementation
 *	for Uuid6Col.
 */
public class CFBamXmlLoaderUuid6ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderUuid6ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamUuid6ColEditObj editBuff = (ICFBamUuid6ColEditObj)schemaObj.getUuid6ColTableObj().newInstance().beginEdit();
			...
			ICFBamUuid6ColEditObj editUuid6Col = editBuff;
			ICFBamUuid6ColObj origUuid6Col = (ICFBamUuid6ColObj)editUuid6Col.create();
			editUuid6Col = null;

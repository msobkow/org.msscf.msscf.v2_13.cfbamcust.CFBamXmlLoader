...
/*
 *	CFBamXmlLoaderDbKeyHash256TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash256Type.
 */
public class CFBamXmlLoaderDbKeyHash256TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash256TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash256TypeEditObj editBuff = (ICFBamDbKeyHash256TypeEditObj)schemaObj.getDbKeyHash256TypeTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash256TypeEditObj editDbKeyHash256Type = editBuff;
			ICFBamDbKeyHash256TypeObj origDbKeyHash256Type = (ICFBamDbKeyHash256TypeObj)editDbKeyHash256Type.create();

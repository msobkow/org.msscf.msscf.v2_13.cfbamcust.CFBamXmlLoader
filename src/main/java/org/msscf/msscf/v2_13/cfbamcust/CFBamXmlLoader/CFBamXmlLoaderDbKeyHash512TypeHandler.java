...
/*
 *	CFBamXmlLoaderDbKeyHash512TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash512Type.
 */
public class CFBamXmlLoaderDbKeyHash512TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash512TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash512TypeEditObj editBuff = (ICFBamDbKeyHash512TypeEditObj)schemaObj.getDbKeyHash512TypeTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash512TypeEditObj editDbKeyHash512Type = editBuff;
			ICFBamDbKeyHash512TypeObj origDbKeyHash512Type = (ICFBamDbKeyHash512TypeObj)editDbKeyHash512Type.create();

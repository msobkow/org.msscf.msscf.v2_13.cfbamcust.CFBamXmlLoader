...
/*
 *	CFBamXmlLoaderDbKeyHash128TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash128Type.
 */
public class CFBamXmlLoaderDbKeyHash128TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash128TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash128TypeEditObj editBuff = (ICFBamDbKeyHash128TypeEditObj)schemaObj.getDbKeyHash128TypeTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash128TypeEditObj editDbKeyHash128Type = editBuff;
			ICFBamDbKeyHash128TypeObj origDbKeyHash128Type = (ICFBamDbKeyHash128TypeObj)editDbKeyHash128Type.create();

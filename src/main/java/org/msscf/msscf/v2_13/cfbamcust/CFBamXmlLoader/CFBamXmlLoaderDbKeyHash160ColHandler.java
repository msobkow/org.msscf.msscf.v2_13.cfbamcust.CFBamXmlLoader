...
/*
 *	CFBamXmlLoaderDbKeyHash160ColParse XML SAX Element Handler implementation
 *	for DbKeyHash160Col.
 */
public class CFBamXmlLoaderDbKeyHash160ColHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash160ColHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash160ColEditObj editBuff = (ICFBamDbKeyHash160ColEditObj)schemaObj.getDbKeyHash160ColTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash160ColEditObj editDbKeyHash160Col = editBuff;
			ICFBamDbKeyHash160ColObj origDbKeyHash160Col = (ICFBamDbKeyHash160ColObj)editDbKeyHash160Col.create();

...
/*
 *	CFBamXmlLoaderDbKeyHash384TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash384Type.
 */
public class CFBamXmlLoaderDbKeyHash384TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash384TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash384TypeEditObj editBuff = (ICFBamDbKeyHash384TypeEditObj)schemaObj.getDbKeyHash384TypeTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash384TypeEditObj editDbKeyHash384Type = editBuff;
			ICFBamDbKeyHash384TypeObj origDbKeyHash384Type = (ICFBamDbKeyHash384TypeObj)editDbKeyHash384Type.create();

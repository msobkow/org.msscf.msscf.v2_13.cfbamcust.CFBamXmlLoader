 ...
 */
public class CFBamXmlLoaderServerImplLicenseHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderServerImplLicenseHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "ServerImplLicense" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalServerImplLicenseText( text );

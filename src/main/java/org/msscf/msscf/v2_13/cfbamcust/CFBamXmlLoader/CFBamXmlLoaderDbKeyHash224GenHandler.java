...
import org.msscf.msscf.v2_13.cflib.CFLib.dbutil.CFLibDbKeyHash224;
...
/*
 *	CFBamXmlLoaderDbKeyHash224GenParse XML SAX Element Handler implementation
 *	for DbKeyHash224Gen.
 */
public class CFBamXmlLoaderDbKeyHash224GenHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash224GenHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash224GenEditObj editBuff = (ICFBamDbKeyHash224GenEditObj)schemaObj.getDbKeyHash224GenTableObj().newInstance().beginEdit();
			...
			CFLibDbKeyHash224 natInitValue;
			if( ( attrInitValue == null ) || ( attrInitValue.length() <= 0 ) ) {
				natInitValue = CFLibDbKeyHash224.nullGet();
			}
			else {
				natInitValue = CFLibDbKeyHash224.fromHex( attrInitValue );
			}
			...
			ICFBamDbKeyHash224GenEditObj editDbKeyHash224Gen = editBuff;
			ICFBamDbKeyHash224GenObj origDbKeyHash224Gen = (ICFBamDbKeyHash224GenObj)editDbKeyHash224Gen.create();

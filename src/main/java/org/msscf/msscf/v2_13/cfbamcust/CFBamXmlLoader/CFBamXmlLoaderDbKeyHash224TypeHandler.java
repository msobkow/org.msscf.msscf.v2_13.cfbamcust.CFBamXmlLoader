...
/*
 *	CFBamXmlLoaderDbKeyHash224TypeParse XML SAX Element Handler implementation
 *	for DbKeyHash224Type.
 */
public class CFBamXmlLoaderDbKeyHash224TypeHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderDbKeyHash224TypeHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFBamDbKeyHash224TypeEditObj editBuff = (ICFBamDbKeyHash224TypeEditObj)schemaObj.getDbKeyHash224TypeTableObj().newInstance().beginEdit();
			...
			ICFBamDbKeyHash224TypeEditObj editDbKeyHash224Type = editBuff;
			ICFBamDbKeyHash224TypeObj origDbKeyHash224Type = (ICFBamDbKeyHash224TypeObj)editDbKeyHash224Type.create();

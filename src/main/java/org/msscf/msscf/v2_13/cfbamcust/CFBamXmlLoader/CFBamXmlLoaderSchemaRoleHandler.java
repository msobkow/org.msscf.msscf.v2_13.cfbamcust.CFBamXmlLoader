...
// Description: Java 11 XML SAX Element Handler for SchemaRole
...
/*
 *	CFBamXmlLoaderSchemaRoleParse XML SAX Element Handler implementation
 *	for SchemaRole.
 */
public class CFBamXmlLoaderSchemaRoleHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderSchemaRoleHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFBamSchemaRoleObj origSchemaRole = (ICFBamSchemaRoleObj)schemaObj.getSchemaRoleTableObj().readSchemaRoleByUNameIdx( refTenant.getRequiredId(),
			refScopeDef.getRequiredId(),

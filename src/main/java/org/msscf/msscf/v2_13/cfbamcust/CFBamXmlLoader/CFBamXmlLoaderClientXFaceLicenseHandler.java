 ...
 */
public class CFBamXmlLoaderClientXFaceLicenseHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderClientXFaceLicenseHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "ClientXFaceLicense" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setOptionalClientXFaceLicenseText( text );

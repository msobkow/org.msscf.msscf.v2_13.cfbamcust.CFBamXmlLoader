 ...
 */
public class CFBamXmlLoaderCommonLicenseHandler
	extends CFLibXmlCoreElementHandler
{
	public CFBamXmlLoaderCommonLicenseHandler( CFBamXmlLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		assert qName.equals( "CommonLicense" );
	...
	throws SAXException
	{
		...
		editSchemaDef.setRequiredCommonLicenseText( text );
